...
#ifndef H_MET_LAB2_LU_DECOMPOSITION_H
#define H_MET_LAB2_LU_DECOMPOSITION_H
...
private:
    ...
    std::vector<double> Make_z(const std::vector<double> &_b) {
        std::vector<double> z(n);

        std::vector<double> b = p * _b;
...
#endif //H_MET_LAB2_LU_DECOMPOSITION_H
